...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Tambah Jadwal Penerbangan</div>

                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin-flight.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="datetime-local" name="berangkat" value="{{ old('berangkat') }}"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="datetime-local" name="tiba" value="{{ old('tiba') }}"
